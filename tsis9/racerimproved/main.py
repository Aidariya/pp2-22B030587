...
path = r'c:\Users\Aidariya1\Desktop\pp2-22B030587\tsis9\racerimproved\\'
...
coin_1    = pygame.image.load(path + 'money1.png')
coin_2    = pygame.image.load(path + 'money2.png')
coin_3    = pygame.image.load(path + 'money3.png')
...
def main():
    ...
    while running:
        ...
        coins_text = font_small.render("Coins: " + str(COLLECTED), True, BLACK)
